  ...
  <div class="space-y-2">
    ...
    <form class="flex gap-2" @submit.prevent="addComment">
      <input
        ...
        class="flex-1 rounded border border-slate-300 bg-white px-3 py-1.5 text-sm text-slate-900 placeholder:text-slate-400"
      />
      <button
        type="submit"
...
const { data: commentsData, refresh } = useAsyncData(
